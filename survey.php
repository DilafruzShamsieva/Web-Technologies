...
<html>
  ...
  <body>
    ...
    <input type="radio" name="question12" value="Strongly Disagree"> Strongly Disagree<br>
    <input type="radio" name="question12" value="Disagree"> Disagree<br>
    <input type="radio" name="question12" value="Somewhat"> Somewhat<br>
    <input type="radio" name="question12" value="Agree"> Agree<br>
    <input type="radio" name="question12" value="Strongly Agree"> Strongly Agree<br>
    <br>

    <p>Question 13: You often find yourself daydreaming or lost in thought.</p>
    <input type="radio" name="question13" value="Strongly Disagree"> Strongly Disagree<br>
    <input type="radio" name="question13" value="Disagree"> Disagree<br>
    <input type="radio" name="question13" value="Somewhat"> Somewhat<br>
    <input type="radio" name="question13" value="Agree"> Agree<br>
    <input type="radio" name="question13" value="Strongly Agree"> Strongly Agree<br>
    <br>

    <p>Question 14: You prefer exploring new ideas and concepts rather than sticking to familiar routines.</p>
    <input type="radio" name="question14" value="Strongly Disagree"> Strongly Disagree<br>
    <input type="radio" name="question14" value="Disagree"> Disagree<br>
    <input type="radio" name="question14" value="Somewhat"> Somewhat<br>
    <input type="radio" name="question14" value="Agree"> Agree<br>
    <input type="radio" name="question14" value="Strongly Agree"> Strongly Agree<br>
    <br>

    <p>Question 15: You believe that intuition plays a significant role in decision-making, alongside logic and reason.</p>
    <input type="radio" name="question15" value="Strongly Disagree"> Strongly Disagree<br>
    <input type="radio" name="question15" value="Disagree"> Disagree<br>
    <input type="radio" name="question15" value="Somewhat"> Somewhat<br>
    <input type="radio" name="question15" value="Agree"> Agree<br>
    <input type="radio" name="question15" value="Strongly Agree"> Strongly Agree<br>
    <br>
    </form>
